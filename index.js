$(document).ready(function () {
  $(".add-btn").click(function () {
    $(".item-table-js").append(
      '<tr class="item"> <td "> <div class="two-cells"> <div> <input type="text" list="item-options" class="item-name-byus"> </div> <div>  </div> </div> </td> <td "> <input type="text" class="cal quantity" placeholder="0"  list="quantity-option"/> </td> <td "> <input type="text" class="cal rate" placeholder="0" /> </td> <td><input type="text" class="cal tax" placeholder="0" /></td> <td "> <input type="text" class="r-tot"  placeholder="0" readonly /> </td> <td> <div><a href= "javascript:void(0)" class="remove-btn">X</a></div> </td> </tr>'
    );
  });
